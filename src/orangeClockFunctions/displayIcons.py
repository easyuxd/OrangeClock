        ...
        labels = [
            ...
            Label(
                ...
                int(
                    (
                        rowMaxDisplay
                        - Writer.stringlen(wri_small, textRow2)
                        + Writer.stringlen(wri_iconsSmall, symbolRow2)
                        + 2  # spacing
                    )
                    / 2
                ),
            ...
            Label(
                ...
                int(
                    (
                        rowMaxDisplay
                        - Writer.stringlen(wri_large, mempoolFees)
                        + Writer.stringlen(wri_iconsLarge, symbolRow3)
                        + 4  # spacing
                    )
                    / 2
                ),
